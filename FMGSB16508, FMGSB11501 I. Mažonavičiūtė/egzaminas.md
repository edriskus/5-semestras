...
7. Technologijas kuriant turi būti išaiškinama:
    ...
    - Dizainas
    - Info turinys
8. Kompiuteriai/ įrenginiai gali būti skirstomi pagal:
    1. Jutimo rūšį
        1. Lytėjimas
        2. Matymas
        3. Klausa
    2. Paskirtį
    3. Formą/dizainą
9. **Sąveika** - kaip bendraujam su kompiuteriu, įvesties ir išvesties būdai. Tipai:
...
1. **User experience design (UXD)** - naudotojų pasitenkinimo ir ištikimybės produktui pagerinimo procesas tobulinant: 
    -  panaudojamumą (Usability), 
    -  naudojimosi paprastumą (Ease of use) 
    -  sąveikos su produktu pasitenkinimą.
2. Į UXD įeina:
    - Produkto turinys
    - Panaudojamumas
...
- Vartotojo analizės metodai:
    1. Hipotezių patvirtinimas/neigimas (apribotos sąlygos)(Daug dalyvių)
...
## Socialinių tinklų ar big data analizė duomenims apie naudotojus gauti
...
1. Surašyti visą žinomą informaciją apie žinomus klientus ir sugrupuoti esamą informaciją lentelėje.
2. Peržvelgti visą informaciją ir surasti atitinkamas tendencijas. (kur dirbama, kuriuo metu yra vykdoma atitinkama veikla ir t.t.)
3. Poto kai tendencijos surastos, suformuluoti klausimus apie savo klientus ir surasti ką jie turi panašaus ir kokie yra jų skirtumai.
4. Surasti žmones, kurie atitinka šias personas ir klausinėti papildomų klausimų.
5. Sudėti visą informaciją į lentelę atgal ir vėl ją peržvelgti.
